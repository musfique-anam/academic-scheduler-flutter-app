...
class _AdminDashboardState extends State<AdminDashboard> {
  ...
  // 🔥 Handle back-button: sub-screen → go to dashboard; dashboard → exit popup
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            icon: Icon(
                _selectedIndex == 0 ? Icons.menu : Icons.arrow_back,
                size: 24),
            onPressed: () {
              if (_selectedIndex == 0) {
  ...
  String _getAppBarTitle() {
    switch (_selectedIndex) {
      ...
      case 3: return 'Batches';
      case 4: return 'Courses';
      case 5: return 'Rooms';
      case 6: return 'Merge Sections';
      case 7: return 'Room Assignment';
      case 8: return 'Generate Routine';
      case 9: return 'View Routine';
      case 10: return 'Insert Data';
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              _buildInfoChip(
                  Icons.pending, '${provider.pendingTasks} pending'),
            ],
          ),
        ],
      ),
  ...
  Widget _buildStatisticsCards(DashboardProvider provider) {
    ...
    return GridView.count(
      ...
      children: [
        _buildStatCard('Departments', '${provider.totalDepartments}',
            Icons.business, Colors.blue,
            onClick: () => setState(() => _selectedIndex = 1)),
        _buildStatCard('Teachers', '${provider.totalTeachers}',
            Icons.person, Colors.green,
            onClick: () => setState(() => _selectedIndex = 2)),
        _buildStatCard('Batches', '${provider.totalBatches}', Icons.group,
            Colors.orange,
            onClick: () => setState(() => _selectedIndex = 3)),
        _buildStatCard('Students', '${provider.totalStudents}',
            Icons.people, Colors.purple,
            onClick: () => _showComingSoon(context)),
        _buildStatCard('Courses', '${provider.totalCourses}', Icons.book,
            Colors.red,
            onClick: () => setState(() => _selectedIndex = 4)),
        _buildStatCard('Rooms', '${provider.totalRooms}',
            Icons.meeting_room, Colors.teal,
            onClick: () => setState(() => _selectedIndex = 5)),
        _buildStatCard('Active Classes', '${provider.activeClasses}',
            Icons.class_, Colors.indigo,
            onClick: () => _showComingSoon(context)),
        _buildStatCard("Today's Routines", '${provider.todayRoutines}',
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView(
            ...
            children: [
              _buildQuickActionButton('Generate\nRoutine', Icons.schedule,
                  Colors.blue,
                  () => _navigateToScreen(const RoutineGenerationScreen())),
              _buildQuickActionButton('Merge\nSections', Icons.merge_type,
                  Colors.green,
                  () => _navigateToScreen(const MergeSectionScreen())),
              _buildQuickActionButton('Assign\nRooms', Icons.assignment,
                  Colors.orange,
                  () => _navigateToScreen(const RoomAssignmentScreen())),
              _buildQuickActionButton('View\nRoutine', Icons.remove_red_eye,
                  Colors.purple,
                  () => _navigateToScreen(const ViewRoutineScreen())),
              _buildQuickActionButton('Add Teacher', Icons.person_add,
                  Colors.red,
                  () => _navigateToScreen(const TeacherScreen())),
              _buildQuickActionButton('Add Batch', Icons.group_add,
                  Colors.teal,
                  () => _navigateToScreen(const BatchScreen())),
              _buildQuickActionButton('Insert Data', Icons.storage,
                  Colors.amber,
  ...
  Widget _buildSelectedScreen() {
    switch (_selectedIndex) {
      case 1: return const DepartmentScreen();
      case 2: return const TeacherScreen();
      case 3: return const BatchScreen();
      case 4: return const CourseScreen();
      case 5: return const RoomScreen();
      case 6: return const MergeSectionScreen();
      case 7: return const RoomAssignmentScreen();
      case 8: return const RoutineGenerationScreen();
      case 9: return const ViewRoutineScreen();
      case 10: return const DataInsertionScreen();
      case 11: return const ProfileScreen();
      case 12: return const SettingsScreen();
      default:
        return _buildDashboardContent(
            context, Provider.of<DashboardProvider>(context));
    }
  }
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return ListTile(
                      ...
                      subtitle: const Text('New update in the system',
